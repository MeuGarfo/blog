...
<head>
    ...
    <link rel="stylesheet" href="/asset/bower_components/1k/dist/1k.min.css?2.0.4">
...
<body>
    <div class="c">
        ...
        <div class="r">
            <div class="g12 center">
                <p>O código fonte deste blog<br>está no <a href="https://github.com/hackergaucho/blog">Github</a></p>
            </div>
        </div>
    </div><!--.c-->
</body>
